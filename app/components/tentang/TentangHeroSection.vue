  ...
  <section class="relative min-h-[70vh] md:min-h-[85vh] flex items-center">
    ...
    <div class="relative z-10 container-main w-full">
      ...
      <div class="text-left mb-8 md:mb-10 max-w-2xl">
        <h1 class="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-4 italic">
      ...
      <div class="flex flex-wrap justify-start gap-3 md:gap-4">
        <div
          v-for="stat in stats"
          :key="stat.key"
          class="bg-gradient-to-r from-[#D4A84B] to-[#8B6914] rounded-2xl px-4 py-3 md:px-6 md:py-4 flex items-center gap-3 min-w-[120px] md:min-w-[140px]"
        >
          <!-- Icon -->
